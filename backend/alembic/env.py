...
Pulls the database URL from application settings (never hard-coded) and uses the
app's SQLAlchemy metadata as the autogenerate target, so `alembic revision
